...
var add_link = function(){
    ...
    if(is_music){
        ...
        div.innerHTML = '<a style="color:black" href="'+play_url+'" target="_blank" class="yt-uix-button yt-uix-button-size-default yt-uix-button-opacity yt-uix-button-has-icon no-icon-markup yt-uix-videoactionmenu-button addto-button  yt-uix-tooltip"  ><span class="yt-uix-button-content">Find on Play Music</span></a>';
